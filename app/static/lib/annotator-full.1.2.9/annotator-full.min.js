...
!function () {
  ...
  Annotator.Plugin.Store = (function (_super) {
    ...
    portaugmenter = jQuery("#data").data();

    Store.prototype.options = {
      annotationData: {},
      emulateHTTP: false,
      loadFromSearch: false,
      prefix: "http://127.0.0.1:80/augmenterservice",
      urls: {
        create: "/annotations",
        read: "/annotations/:id",
    ...
    Store.prototype._apiRequest = function (action, obj, onSuccess) {
      ...
      if (action === "create") {
        ...
        request = $.ajax({
          url:
            "http://127.0.0.1:80/augmenterservice/annotations/" +
            datosAnotacion.id,
          dataType: "json",
          type: "put",
          contentType: "application/json",
  ...
  Annotator.prototype.setupPlugins = function (config, options) {
    ...
    pluginConfig = {
      ...
      Auth: {
        tokenUrl: config.tokenUrl || "http://127.0.0.1:8000/token",
      },
      Store: {
        prefix: config.storeUrl || "http://127.0.0.1:80/augmenterservice/api",
        annotationData: {
          uri: uri,
        },
        loadFromSearch: {
