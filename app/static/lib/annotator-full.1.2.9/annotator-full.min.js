...
!function () {
  ...
  simpleXPathJQuery = function (relativeRoot) {
    ...
    jq = this.map(function () {
      ...
      elem = this;
      while (
        (elem != null ? elem.nodeType : void 0) === Node.ELEMENT_NODE &&
        elem !== relativeRoot
      ) {
  ...
  if (
    ...
    console.error(
      _t("Annotator requires jQuery: have you included lib/vendor/jquery.js?")
    );
  }
  ...
  Util.nodeFromXPath = function (xp, root) {
    ...
    for (_i = 0, _len = steps.length; _i < _len; _i++) {
      ...
      idx =
        idx != null ? parseInt((idx != null ? idx.split("]") : void 0)[0]) : 1;
  ...
  Util.mousePosition = function (e, offsetEl) {
    var offset, _ref1;
    if (
      (_ref1 = $(offsetEl).css("position")) !== "absolute" &&
      _ref1 !== "fixed" &&
      _ref1 !== "relative"
    ) {
  ...
  Delegator = (function () {
    ...
    Delegator.prototype._removeEvent = function (
      selector,
      event,
      functionName
    ) {
  ...
  Delegator._parseEvents = function (eventsObj) {
    ...
    for (sel in eventsObj) {
      ...
      (_ref1 = sel.split(" ")),
        (selector =
          2 <= _ref1.length
            ? __slice.call(_ref1, 0, (_k = _ref1.length - 1))
            : ((_k = 0), [])),
        (event = _ref1[_k++]);
      events.push({
  ...
  Range.BrowserRange = (function () {
    ...
    BrowserRange.prototype.normalize = function (root) {
      ...
      if (this.tainted) {
        console.error(
          _t("You may only call normalize() once on a BrowserRange!")
        );
        return false;
      } else {
        this.tainted = true;
  ...
  Annotator = (function (_super) {
    ...
    function Annotator(element, options) {
      ...
      this.onHighlightMouseoverEfect = __bind(this.onHighlightMouseoverEfect, this);
        ...
        .addField({
          load: (function (_this) {
            return function (field, annotation) {
              ...
              return _this.publish("annotationViewerTextField", [
                field,
                annotation,
              ]);
            };
    ...
    Annotator.prototype._setupDynamicStyle = function () {
      ...
      if (!style.length) {
        style = $('<style id="annotator-dynamic-style"></style>').appendTo(
          document.head
        );
      }
      sel =
    ...
    Annotator.prototype.getSelectedRanges = function () {
      ...
      if (!selection.isCollapsed) {
        ranges = function () {
          ...
          _results = [];
          for (
            i = _k = 0, _ref1 = selection.rangeCount;
    ...
    Annotator.prototype.setupAnnotation = function (annotation) {
      ...
      if (_ref1 != null) {
        //Excluyo el cargar huerfanos de la pagina
        for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
          r = _ref1[_k];
          try {
      ...
      for (_l = 0, _len3 = normedRanges.length; _l < _len3; _l++) {
        ...
        //En el caso que sea una anotacion de otro usuario
        try{
          root = this.wrapper[0];
        } catch (e){
          root=$("div.annotator-wrapper")[0];
    ...
    Annotator.prototype.deleteAnnotation = function (annotation) {
      highlightsEncontrados = $(annotation.highlights).data();
    ...
    Annotator.prototype.addPlugin = function (name, options) {
      ...
      if (this.plugins[name]) {
        console.error(
          _t("You cannot have more than one instance of any plugin.")
        );
      } else {
    ...
    Annotator.prototype.checkForEndSelection = function (event) {
      ...
      if (event && this.selectedRanges.length) {
        return this.adder
          .css(Util.mousePosition(event, this.wrapper[0]))
          .show();
      } else {
    ...
    Annotator.prototype.isAnnotator = function (element) {
      return !!$(element)
        ...
        .not(this.wrapper).length;
    };

    Annotator.prototype.onHighlightMouseoverEfect = function (anotacion) {
      this.clearViewerHideTimer();
      if (this.mouseIsDown || Annotator.prototype.viewer.isShown()) {
        return false;
      }

      elementoEncontrado=$('span#'+anotacion['id']);

      return Annotator.prototype.showViewer(
        $.makeArray(annotation),
        elementoEncontrado.position()
    ...
    Annotator.prototype.onHighlightMouseover = function (event) {
      ...
      var parentsET = eventTarget.parents(".annotator-hl");
      var parentsyBack = parentsET.addBack();
      var parentsTrans = parentsyBack.map(function () {
        annotationFound = $(this).data("annotation");
        return annotationFound;
      });

      annotations = parentsTrans;

      return this.showViewer(
        $.makeArray(annotations),
        Util.mousePosition(event, this.wrapper[0])
      );
    };
  ...
  Annotator.Widget = (function (_super) {
    ...
    function Widget(element, options) {
      ...
      this.classes = $.extend(
        {},
        Annotator.Widget.prototype.classes,
        this.classes
      );
    }
  ...
  Annotator.Editor = (function (_super) {
    ...
    //Just options of save to users logged
    ...
    Editor.prototype.setupDraggables = function () {
      ...
      if (this.element.hasClass(this.classes.invert.y)) {
        cornerItem = this.element.find(".:last");
      } else {
  ...
  Annotator.Notification = (function (_super) {
    ...
    function Notification(options) {
      this.hide = __bind(this.hide, this);
      this.show = __bind(this.show, this);
      Notification.__super__.constructor.call(
        this,
        $(this.options.html).appendTo(document.body)[0],
        options
      );
    }
  ...
  Annotator.Plugin.Unsupported = (function (_super) {
    ...
    Unsupported.prototype.options = {
      message: Annotator._t(
        "Sorry your current browser does not support the Annotator"
      ),
    };
        ...
        return $(
          (function (_this) {
            return function () {
              ...
              if (
                window.XMLHttpRequest === void 0 &&
                ActiveXObject !== void 0
              ) {
        ...
        .fail(
          (function (_this) {
            return function (xhr, status, err) {
              ...
              return Annotator.showNotification(
  ...
  Annotator.Plugin.Store = (function (_super) {
    ...
    enlaceElasticSeach = $("dataBackEnd");
          ...
          (function (_this) {
            return function (data) {
              if (data.id == null) {
                ...
                //Creo en Base de Datos SQLLite de la Applicacion FLask
                //Obtengo el Usuario:
                win = Annotator.Util.getGlobal();
                data.uri = win.location.href.split(/#|\?/).shift() || "";

                /*request = $.ajax({
                  url: "http://127.0.0.1:8000/annotation",
                  dataType: "json",
                  type: "post",
                  headers: { "user-Id": "123456789" },
    ...
    Store.prototype.annotationUpdated = function (annotation) {
      if (__indexOf.call(this.annotations, annotation) >= 0) {
        return this._apiRequest(
          ...
          (function (_this) {
            return function (data) {
              //Actualizo tambien en la base de datos del Flask:
              //Creo en Base de Datos SQLLite de la Applicacion FLask
              /*request = $.ajax({
                url: "http://127.0.0.1:8000/annotation",
                dataType: "json",
      ...
      if (__indexOf.call(this.annotations, annotation) >= 0) {
        return this._apiRequest(
          ...
          (function (_this) {
            return function () {
              //Actualizo tambien en la base de datos del Flask:
              //Delete en Base de Datos SQLLite de la Applicacion FLask

              /*request = $.ajax({
                url: "http://127.0.0.1:8000/annotation/" + annotation.id,
                dataType: "json",
                type: "delete",
                contentType: "application/json",
                processData: false,
        ...
        annotationEncontrada = this.annotations.find(
          (element) => element.id == annotation.id
        );

        return this._apiRequest(
          "destroy",
          annotationEncontrada,
          (function (_this) {
            return function () {
              //Actualizo tambien en la base de datos del Flask:
              //Delete en Base de Datos SQLLite de la Applicacion FLask
              ...
              return _this.unregisterAnnotation(annotationEncontrada);
            };
          })(this)
        );
      }
    ...
    Store.prototype.updateAnnotation = function (annotation, data) {
      let idTemporal=annotation['id'];
      let idNuevo='';
      if (__indexOf.call(this.annotations, annotation) < 0) {
        console.error(
          Annotator._t("Trying to update unregistered annotation!")
        );
      } else {
        $.extend(annotation, data);
      }

      idNUevo=annotation['id'];
      
      //Cambios los ids por los correctos:
      $("#"+idTemporal).attr("id", idNUevo);
      $("#annotation-"+idTemporal).attr("id", "annotation-"+idNUevo);
      $("#cont-"+idTemporal).attr("id", "cont-"+idNUevo);
      $("#timecont-"+idTemporal).attr("id", "timecont-"+idNUevo);
    ...
    Store.prototype._apiRequest = function (action, obj, onSuccess) {
      ...
      if (action === "create") {
        datosAnotacion = JSON.parse(options.data);
        //console.log(datosAnotacion);
        //console.log(options.data);
        //console.log(JSON.stringify(options.data));

        //Creo en Base de Datos ElasticSearch
        request = $.ajax({
          url: servicepediaPath + "/annotations",
          dataType: "json",
          type: "post",
          contentType: "application/json",
          data: JSON.stringify(datosAnotacion),
          processData: false,
          success: onSuccess,
          error: function (jqXhr, textStatus, errorThrown) {
            console.log(errorThrown);
        ...
        request = $.ajax({
          url: servicepediaPath + "/annotations/" + datosAnotacion.id,
          dataType: "json",
          type: "put",
          contentType: "application/json",
          data: JSON.stringify(datosAnotacion),
    ...
    Store.prototype._onError = function (xhr) {
      ...
      action = xhr._action;
      message =
        Annotator._t("Sorry we could not ") +
        action +
        Annotator._t(" this annotation");
      if (xhr._action === "search") {
        ...
        message =
          Annotator._t("Sorry we could not ") +
          action +
          Annotator._t(" the annotations from the store");
      }
      switch (xhr.status) {
        case 401:
          message =
            Annotator._t("Sorry you are not allowed to ") +
            action +
            Annotator._t(" this annotation");
          break;
        case 404:
      ...
      return console.error(
        Annotator._t("API request failed:") + (" '" + xhr.status + "'")
      );
    };
    return Store;
  })(Annotator.Plugin);
  Annotator.Plugin.Permissions = (function (_super) {
    ...
    function Permissions(element, options) {
      ...
      this.updateAnnotationPermissions = __bind(
    ...
    Permissions.prototype.authorize = function (action, annotation, user) {
      ...
      if (this.options.userAuthorize) {
        return this.options.userAuthorize.call(
          this.options,
          action,
          annotation,
          user
    ...
    Permissions.prototype.updatePermissionsField = function (
      action,
      field,
      annotation
    ) {
    ...
    Permissions.prototype.updateAnnotationPermissions = function (
      type,
      field,
      annotation
    ) {
      ...
      if ($(field).find("input").is(":checked")) {
        ...
        return (annotation.permissions[type] = [
          this.options.userId(this.user),
        ]);
      }
    };
    Permissions.prototype.updateViewer = function (
      field,
      annotation,
      controls
    ) {
  ...
  Annotator.Plugin.AnnotateItPermissions = (function (_super) {
    ...
    AnnotateItPermissions.prototype.options = {
      ...
      userAuthorize: function (action, annotation, user) {
        ...
        if (
          ((_ref2 = this.groups.world),
          __indexOf.call(action_field, _ref2) >= 0)
        ) {
          return true;
        } else if (
          user != null &&
          ...
          if (
            user.userId === annotation.user &&
            user.consumerKey === annotation.consumer
          ) {
            return true;
          } else if (
            ((_ref3 = this.groups.authenticated),
            __indexOf.call(action_field, _ref3) >= 0)
          ) {
            return true;
          } else if (
            user.consumerKey === annotation.consumer &&
            ((_ref4 = this.groups.consumer),
            __indexOf.call(action_field, _ref4) >= 0)
          ) {
            return true;
          } else if (
            user.consumerKey === annotation.consumer &&
            ((_ref5 = user.userId), __indexOf.call(action_field, _ref5) >= 0)
          ) {
            return true;
    ...
    AnnotateItPermissions.prototype.addFieldsToAnnotation = function (
      annotation
    ) {
      if (annotation) {
        annotation.permissions = this.options.permissions;
    ...
    AnnotateItPermissions.prototype.updatePermissionsField = function (
      action,
      field,
      annotation
    ) {
      ...
      if (
        this.user &&
        this.authorize(action, annotation || {}, {
    ...
    AnnotateItPermissions.prototype.updateAnnotationPermissions = function (
      type,
      field,
      annotation
    ) {
      ...
      if ($(field).find("input").is(":checked")) {
        return (annotation.permissions[type] = [
          type === "read"
            ? this.options.groups.world
            : this.options.groups.consumer,
        ]);
      } else {
        return (annotation.permissions[type] = []);
      }
  ...
  Annotator.Plugin.Filter = (function (_super) {
    ...
    Filter.prototype.html = {
      element:
        ...
        Annotator._t("Navigate:") +
        '</strong>\n<span class="annotator-filter-navigation">\n  <button class="annotator-filter-previous">' +
        Annotator._t("Previous") +
        '</button>\n<button class="annotator-filter-next">' +
        Annotator._t("Next") +
        "</button>\n</span>\n<strong>" +
        Annotator._t("Filter by:") +
        "</strong>\n</div>",
      filter:
        '<span class="annotator-filter-property">\n  <label></label>\n  <input/>\n  <button class="annotator-filter-clear">' +
        Annotator._t("Clear") +
        "</button>\n</span>",
    };
    ...
    function Filter(element, options) {
      ...
      var _base;
      element = $(this.html.element).appendTo(
        (options != null ? options.appendTo : void 0) || this.options.appendTo
      );
    ...
    Filter.prototype.filterHighlights = function () {
      ...
      filtered =
        ((_ref2 = activeFilters[0]) != null ? _ref2.annotations : void 0) || [];
  ...
  Annotator.Plugin.Markdown = (function (_super) {
    ...
    function Markdown(element, options) {
      ...
      if (
        (typeof Showdown !== "undefined" && Showdown !== null
          ? Showdown.converter
          : void 0) != null
      ) {
  ...
  Annotator.prototype.setupPlugins = function (config, options) {
    ...
    pluginConfig = {
      ...
      Auth: {
        tokenUrl: config.tokenUrl || +servicepediaPath + "/token",
      },
      Store: {
        prefix: config.storeUrl || +servicepediaPath + "/api",
        annotationData: {
          uri: uri,
        },
        loadFromSearch: {
