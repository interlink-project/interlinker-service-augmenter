...
Annotator.Plugin.RichEditor = (function (_super) {
  ...
  RichEditor.prototype.pluginInit = function () {
    ...
    this.annotator.subscribe("annotationEditorShown", function (annotation) {
      var text =
        typeof annotation.annotation.text != "undefined"
    ...
    this.annotator.viewer.addField({
      load: function (field, annotation) {
        EditorViewerTextField = $(field.parentElement).find(
          "div:first-of-type"
        );
