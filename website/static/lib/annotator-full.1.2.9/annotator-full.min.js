...
!function () {
  ...
  Annotator.Plugin.Store = (function (_super) {
    ...
    Store.prototype.annotationDeleted = function (annotation) {
      ...
      if (__indexOf.call(this.annotations, annotation) >= 0) {
        ...
        annotationEncontrada=this.annotations.find(element => element.id==annotation.id);
    ...
    Store.prototype._apiRequest = function (action, obj, onSuccess) {
      ...
      if (action === "create") {
        ...
        request = $.ajax({
          url: "http://127.0.0.1:5000/annotations/" + datosAnotacion.id,
          dataType: "json",
          type: "put",
          contentType: "application/json",
          data: JSON.stringify(datosAnotacion),
  ...
  Annotator.prototype.setupPlugins = function (config, options) {
    ...
    pluginConfig = {
      ...
      Store: {
        prefix: config.storeUrl || "http://127.0.0.1:5000/api",
        annotationData: {
          uri: uri,
        },
        loadFromSearch: {
