...
!function () {
  ...
  Annotator.Plugin.AnnotateItPermissions = (function (_super) {
    ...
    function AnnotateItPermissions() {
      ...
      this.updatePermissionsField = __bind(this.updatePermissionsField, this);
      this.addFieldsToAnnotation = __bind(this.addFieldsToAnnotation, this);
      _ref3 = AnnotateItPermissions.__super__.constructor.apply(
        this,
        arguments
      );
      return _ref3;
      ...
      userAuthorize: function (action, annotation, user) {
        ...
        if (
          ...
          if (
            ...
            ((_ref5 = this.groups.authenticated),
            __indexOf.call(action_field, _ref5) >= 0)
          ) {
            return true;
          } else if (
            user.consumerKey === annotation.consumer &&
            ((_ref6 = this.groups.consumer),
            __indexOf.call(action_field, _ref6) >= 0)
          ) {
            return true;
          } else if (
            user.consumerKey === annotation.consumer &&
            ((_ref7 = user.userId), __indexOf.call(action_field, _ref7) >= 0)
          ) {
            return true;
  ...
  Annotator.Plugin.Filter = (function (_super) {
    ...
    Filter.prototype.addFilter = function (options) {
      var f, filter;
      filter = $.extend(
        { label: "", property: "", isFiltered: this.options.isFiltered },
        options
      );
      if (
        !function () {
    ...
    Filter.prototype.filterHighlights = function () {
      ...
      filtered =
        ((_ref4 = activeFilters[0]) != null ? _ref4.annotations : void 0) || [];
