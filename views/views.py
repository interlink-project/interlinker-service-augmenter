...
views = Blueprint('views',__name__,static_folder="./app/static",template_folder="./app/templates")
...
def claimModeration():
    ...
    if(not allUrlValid):
        ...
        textHref='http://127.0.0.1:5000/aproveModerator?datos='+encMessage.decode('ascii')
...
def modifica(rutaPagina,userId):
    ...
    for a_Link in soup.find_all("a"):
        if a_Link.attrs.get("href"):
            ...
            if hrefVal.startswith('/'):
                ...
                a_Link.attrs['href']="/modifica/d.silva@deusto.es/"+newURLVal.lower()
                print(a_Link)
    ...
    anotationcss1 = soup.new_tag('link', href="/static/lib/annotator-full.1.2.9/annotator.min.css",rel="stylesheet")
    anotationcss2 = soup.new_tag('link', href="/static/src/css/style.css",rel="stylesheet")
    anotationcss3 = soup.new_tag('link', href="/static/lib/css/annotator.touch.css",rel="stylesheet")
    ...
    jqueryScript1 = soup.new_tag('script', src="/static/lib/jquery-1.9.1.js")
    jqueryScript2 = soup.new_tag('script', src="/static/lib/annotator-full.1.2.9/annotator-full.min.js")
    jqueryScript3 = soup.new_tag('script', src="/static/lib/jquery-i18n-master/jquery.i18n.min.js")
    jqueryScript4 = soup.new_tag('script', src="/static/lib/jquery.dateFormat.js")
    jqueryScript5 = soup.new_tag('script', src="/static/lib/jquery.slimscroll.js")

    jqueryScript12 = soup.new_tag('script', src="/static/locale/en/annotator.js")
    jqueryScript13 = soup.new_tag('script', src="/static/lib/tinymce/tinymce.min.js")
    jqueryScript14 = soup.new_tag('script', src="/static/src/richEditor.js")



    jqueryScript6 = soup.new_tag('script', src="/static/lib/lunr.js-0.5.7/lunr.min.js")
    jqueryScript7 = soup.new_tag('script', src="/static/locale/en/annotator.js")
    jqueryScript8 = soup.new_tag('script', src="/static/lib/annotator.touch.js")
    jqueryScript9 = soup.new_tag('script', src="/static/src/view_annotator.js")
    jqueryScript10 = soup.new_tag('script', src="/static/src/categories.js")
    jqueryScript11 = soup.new_tag('script', src="/static/src/search.js")
