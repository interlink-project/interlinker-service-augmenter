...
def assetView(id):
    ...
    return redirect(url_for("views.augment", rutaPagina=urlMainPage)+'?description='+id)
...
def augment(rutaPagina):
    ...
    jqueryScript12 = soup.new_tag(
        'script', src=url_for('static', filename='locale/en/annotator.js'))
